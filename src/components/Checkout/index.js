                ...
                <div className={styles.userInfoContainer}>
                    ...
                    <div className={styles.inputItemContainer}>
                        ...
                        <input
                            ...
                            type="email"
                            value="tranthidiep142@gmail.com"
                        />
                    </div>
                    <div className={styles.inputItemContainer}>
                        ...
                        <input
                            ...
                            type="text"
                            value="AG3 - KTX Khu A ĐHQG TP.HCM"
                        />
                    </div>
                    <div className={styles.inputItemContainer}>
                    ...
                    <div className={styles.inputItemContainer}>
                        ...
                        <button className={styles.btnCheck} type="button">
                            Kiểm tra
                        </button>
                    </div>
                    <div className={styles.inputItemContainer}>
                        ...
                        />
                         {' '}
                        <label className={styles.radioLabel} for="fast">
                            Hỏa tốc
                        </label>
                        <input className={styles.radioInput} type="radio" id="normal" name="transport" value="normal" />
                         {' '}
                        <label className={styles.radioLabel} for="normal">
                            Vận chuyển thường
                        </label>
                    </div>
