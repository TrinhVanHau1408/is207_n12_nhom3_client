...
const styles = {
    ...
    productCartContent: "text-xs bg-indigo-500 px-3 py-2 rounded-md hover:cursor-pointer animate-bounce hover:animate-none hover:text-white hover:bg-yellow-500 transition ease-in-out delay-100 duration-200",
    ...
    <div className={styles.productList}>
        ...
        <div className={styles.productListContainer}>
            <div className={styles.productItem}>
                <div >
                    <img className={styles.productImg} src={imgs.airpodspro}/>
                </div>
            ...
            <div className={styles.productItem}>
                <div >
                    <img className={styles.productImg} src={imgs.applewatchS7}/>
                </div>
                {/* line-clamp-3 */}
                <div className={`${styles.productName} line-clamp-3`} >ZEBRONICS Zeb-Reaper 2.4GHz Wireless Gaming Mouse</div>
                <div className={styles.productPriceContainer}>
                    <div className={styles.productPrice}>4.000.000đ</div>
                    <div className={styles.productDiscount}>-24%</div>
                </div>
            ...
            <div className={styles.productItem}>
                <div >
                    <img className={styles.productImg} src={imgs.applewatchS8}/>
                </div>
