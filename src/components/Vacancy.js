    ...
    <div className={styles.vacancy}>
        ...
        <div className={styles.vacancyContent}>
            <div className={styles.vacancyItem}>
                ...
                <div className={styles.vacancyDesc}>Miễn phí vận chuyển trên toàn quốc cho đơn hàng trên 10 triệu đồng</div>
            </div>
            <div className={styles.vacancyItem}>
                <div className={styles.vacancyIcon}></div>
            ...
            <div className={styles.vacancyItem}>
                ...
                <div className={styles.vacancyDesc}>Chính sách bảo hành trong 2 năm, hoàn trả sản phẩm trong 24 giờ</div>
            </div>
        </div>
