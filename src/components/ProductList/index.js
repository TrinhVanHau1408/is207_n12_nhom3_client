...
const styles = {
    ...
    // productItem: 'basis-1/2 md:basis-1/5 p-6 pb-16 text-left',
    productItem: 'relative basis-1/2 md:basis-1/5 p-6 pb-16 text-left',
    productImg: 'm-auto',
    ...
    productPriceContainer: 'flex justify-between gap-x-1 md:gap-x-8 text-sm text-red-600 absolute bottom-10',
    productPrice: 'font-semibold',
    productDiscount: 'font-bold',
    productAction: 'absolute bottom-0',
    productCart: 'flex text-white pt-4',
    productCartContent:
        'text-xs px-3 py-2 rounded-md hover:cursor-pointer transition ease-in-out delay-100 bg-indigo-500 hover:-translate-y-1 hover:scale-110 duration-200 hover:text-white',
