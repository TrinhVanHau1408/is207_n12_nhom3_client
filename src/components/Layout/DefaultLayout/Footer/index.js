...
const styles = {
    ...
    btnSignIn:
        'text-[#2A254B] bg-white px-3 py-2 hover:text-white hover:bg-yellow-500 transition delay-150 duration-300 ease-in-out',
};
            ...
            <div className={styles.footerContainer}>
                <div className={styles.footerInfo}>
                    <div className={styles.footerItem}>
                        ...
                        <a href="/" className={styles.footerItemContent}>
                            Hàng mới về
                        </a>
                        <a href="/" className={styles.footerItemContent}>
                            Bán chạy
