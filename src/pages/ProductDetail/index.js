                        ...
                        <Row className="product">
                            ...
                            <Col span={10}>
                                ...
                                <Row>
                                    <Col span={4}>
                                        {' '}
                                        <Typography.Text className="product__tinhTrang">Tình trạng</Typography.Text>
                                    </Col>
                                    <Col span={4}>
                                        {' '}
                                        <Typography.Text className="product__tinhTrang">
                                            {quantity ? 'Còn hàng' : 'Hết hàng'}
                                        </Typography.Text>
                                    </Col>
                                </Row>
                                <div className={`${isError ? 'error' : ''}`}>
                                    ...
                                    <Row>
                                        <ButtonStyled className="product__boNho">
                                            <Col span={4}>
                                                <Typography.Text>Bộ nhớ</Typography.Text>
                                            </Col>
                                    ...
                                    {isError && (
                                        <Row className="errContent">
                                            <Col span={24}>
                                                <Typography.Text type="danger">Vui lòng chọn</Typography.Text>
                                            </Col>
                                        </Row>
                                    )}
                                </div>
                                ...
                                <Row>
                                    <DescriptionsStyled title="Khuyến mãi" bordered>
                                        <Descriptions.Item className="product__noiDungKhuyenMai">
                                            FLASH SALE: Tặng voucher 500.000đ giảm trực tiếp vào giá máy Duy nhất tại
                                            Dienthoaihay: iPhone chính hãng VN/A rẻ như hàng cũ xách tay Trợ giá mua củ
                                            sạc nhanh 20W PD chính hãng chỉ 250k Trả góp nhanh, lãi suất 0% qua thẻ tín
                                            dụng Mua Online: Giao hàng tận nhà- Nhận hàng thanh toán Thẻ SIM: Nano +
                                            eSim Màn hình: 6.7 inches, Super Retina XDR OLED, 120Hz, HDR10, Dolby
                                        </Descriptions.Item>
                                    </DescriptionsStyled>
