        ...
        <div className={cx('grid')}>
            <form className={cx('form-info')}>
                ...
                <div className={cx('form-submit')}>
                    <Button danger className={cx('edit')} edit>
                        Chỉnh sửa
                    </Button>
                    <ButtonSaveStyled className={cx('save')} primary>
                        Lưu
                    </ButtonSaveStyled>
                </div>
            </form>
            <div className={cx('buy-history')}>
                ...
                <div className={cx('straight')}>
                    ...
                    {status.map(st => (
                        <Col key={st.id} className={cx('col')} span={4}><div className={cx(`${onclicked == st.id&&'lined'}`)}></div></Col>
            ...
            <div className={cx('delivering')}>
                <div className={cx('delivering-wrap')}>
                    {product.length>0 ? <div><RowPr>
                        ...
                        <Col className="title_product_name" style={{'text-align': 'left'}} span={6}>
                       ...
                       { product.map((pro) => (
                            <RowPr  key={pro.id}>
                                ...
                                <Col span={3}>
                                    <div className={cx('product-price')}>{formatVND(pro.priceSale)}</div>
                                </Col>
                                <Col span={5}>
                    ...
                    </div>:<Col style={{'text-align': 'center'}} span={24}><Typography.Text type='danger' >Không có sản phẩm nào</Typography.Text></Col>
                    }
                </div>
            </div>
